            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div className="flex flex-col">
                    <button type="button" className="text-white bg-[#000000] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
                        ...
                        <path fillRule="evenodd" d="M7.8 0 0 7.15 0 9.75 7.8 9.75 7.8 13 11.05 13 11.05 7.15 3.25 7.15 11.05 0Z" clipRule="evenodd"></path>
                        <path fillRule="evenodd" d="M16.25 3.25 16.25 0 13 3.25 13 0 19.5 0 19.5 3.25 16.25 7.8 16.25 11.05 19.5 7.8 19.5 11.05 13 11.05 13 7.8Z" clipRule="evenodd"></path>
                        </svg>
                        <a
