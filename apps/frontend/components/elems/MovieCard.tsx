    ...
    return (
        <div className="relative group overflow-hidden cursor-pointer">
            <Link href={`/movie/${movie.imdb_code}`}>
                ...
                <svg className={`absolute top-0 right-0 p-1 mr-2 w-8 h-8 text-${colorHeart} opacity-${movie.liked ? '100' : '0'} bg-black rounded-b bg-opacity-50 group-hover:bg-opacity-0`} viewBox="2 2 27 28">
